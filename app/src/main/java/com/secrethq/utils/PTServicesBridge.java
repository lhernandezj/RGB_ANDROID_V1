...
public class PTServicesBridge extends BackupAgent
	...
	public static void showCustomFullScreenAd() {
		Log.d(TAG, "PTServicesBridge  -- showCustomFullScreenAd");
	}

	public static void screenOnEnter(String name){
		Log.d(TAG, "PTServicesBridge  -- screenOnEnter");
	...
	public static void screenOnExit(String name){
		Log.d(TAG, "PTServicesBridge  -- screenOnExit");
		CustomIntegrator customAdIntegrator = AdIntegratorManager.getCustomIntegrator();
		if (customAdIntegrator != null) {
	...
	public static void sceneOnEnter(String name){
		Log.d(TAG, "PTServicesBridge  -- sceneOnEnter");
		CustomIntegrator customAdIntegrator = AdIntegratorManager.getCustomIntegrator();
		if (customAdIntegrator != null) {
	...
	public static void sceneOnExit(String name){
		Log.d(TAG, "PTServicesBridge  -- sceneOnExit");
		CustomIntegrator customAdIntegrator = AdIntegratorManager.getCustomIntegrator();
		if (customAdIntegrator != null) {
	...
	public static void loadingDidComplete() {
		Log.d(TAG, "PTServicesBridge  -- loadingDidComplete");
		CustomIntegrator customAdIntegrator = AdIntegratorManager.getCustomIntegrator();
		if (customAdIntegrator != null) {
	...
	public static void submitScrore( int score ){
		...
		if(PTServicesBridge.mGoogleApiClient == null || PTServicesBridge.mGoogleApiClient.isConnected() == false){
			Log.e(TAG, "Google Play Services is not ready to submit score");
			return;
		}
	...
	public static void setInAppPurchaseInfo(@Nullable ArrayList<Pair<String , String>>  info) {
		...
		if (info != null && info.size() != 0) {
			...
			// trigger the store to load the products
	...
	public static ArrayList<HashMap<String, String>> getInAppPurchaseInfo() {
		...
		ArrayList<HashMap<String, String>> iapInfo = new Gson().fromJson(jsonText, new TypeToken<ArrayList<HashMap<String,String>>>() {}.getType());
		return iapInfo;
	}

	public static ArrayList<String> getInAppIds(String typeName) {
		ArrayList<HashMap<String, String>> iapInfo = getInAppPurchaseInfo();

		ArrayList<HashMap<String, String>> filteredList = new ArrayList<>();
		if(typeName != null && !typeName.isEmpty()){
			for (HashMap<String, String> map : iapInfo) {
				if (map.get("type").equals(typeName)) {
					filteredList.add(map);
				}
			}
		}
		else {
			filteredList = iapInfo;
		}
